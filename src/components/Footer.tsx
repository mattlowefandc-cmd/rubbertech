...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-[#999999]/30" aria-label="Site footer">
      ...
      <div className="max-w-[1720px] mx-auto px-6 py-24 sm:py-32">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-20">
          ...
          <div>
            ...
            <p className="font-body text-[#999999] text-[14px] sm:text-[16px] leading-[1.5] mb-8">
            ...
            <div className="space-y-4">
              <a href="tel:[PHONE_PLACEHOLDER]" className="flex items-center gap-3 font-mono text-[14px] text-[#999999] uppercase tracking-[1.4px] hover:text-black transition-opacity">
                <span>[PHONE_PLACEHOLDER]</span>
              </a>
              <a href="mailto:info@rubber-tech.co.uk" className="flex items-center gap-3 font-mono text-[14px] text-[#999999] uppercase tracking-[1.4px] hover:text-black transition-opacity">
            ...
            <ul className="space-y-4">
              {footerRanges.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="font-mono text-[14px] text-[#999999] uppercase tracking-[1.4px] hover:text-black transition-opacity"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            {/* Social SVGs in #999999 hovering black */}
            <div className="flex items-center gap-6">
              <a href="#" aria-label="FACEBOOK" className="text-[#999999] hover:text-black transition-opacity">
              ...
              <a href="#" aria-label="INSTAGRAM" className="text-[#999999] hover:text-black transition-opacity">
              ...
              <a href="#" aria-label="TWITTER" className="text-[#999999] hover:text-black transition-opacity">
              ...
              <a href="#" aria-label="YOUTUBE" className="text-[#999999] hover:text-black transition-opacity">
      ...
      <div className="border-t border-[#999999]/30">
        <div className="max-w-[1720px] mx-auto px-6 py-6 border-transparent">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <p className="font-mono text-[#999999] text-[12px] uppercase tracking-[1.2px]">
              © {new Date().getFullYear()} RUBBER TECH. AUTHORISED NANKANG DEALER.
            </p>
            <div className="flex items-center gap-8">
              <Link href="/privacy" className="font-mono text-[#999999] text-[12px] uppercase tracking-[1.2px] hover:text-black transition-opacity">PRIVACY POLICY</Link>
              <Link href="/cookies" className="font-mono text-[#999999] text-[12px] uppercase tracking-[1.2px] hover:text-black transition-opacity">COOKIE SETTINGS</Link>
              <Link href="/terms" className="font-mono text-[#999999] text-[12px] uppercase tracking-[1.2px] hover:text-black transition-opacity">TERMS</Link>
            </div>
          </div>
        </div>
      </div>
